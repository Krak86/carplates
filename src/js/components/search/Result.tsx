...
import { IApplicationStates, IVinResultValues, IRiaAds, IPlatesmaniaCars } from "../../models/Interfaces";
...
export const Result = () => {
    const state: IApplicationStates = useSelector((stateInternal: AppState) => stateInternal.Item);
    ...
    return(
        <Fragment>
            ...
            {state.itemIsLoaded === true && state.responseIsEmpty === false && state.itemSearching === 1 &&
                <Table className={classes.table} size="small">
                    <TableBody>
                        ...
                        {state.vinResponse.Results && state.vinResponse.Results.map((item: IVinResultValues) => {
            ...
            {state.itemIsLoaded === true && state.responseIsEmpty === false && state.itemSearching === 0 &&
             state.imageCarsmaniaLoaded === true && state.imagesPlatesMania && state.imagesPlatesMania.length > 0 &&
            ...
            {state.itemIsLoaded === true && state.responseIsEmpty === false && state.itemSearching === 0 &&
             state.imageRiaLoaded === true && state.imagesRia && state.imagesRia.length > 0 &&
            <div className={classes.container}>
